...
const ProfileFieldsLayout = ({
  ...
  return (
    <div className="flex w-[360px] flex-col gap-[12px]" style={{ fontFamily: "Inter, sans-serif" }}>
      <ProfileControlledField control={control} name="fullName" id="profile-full-name" label="Full Name" placeholder="Username" autoComplete="name" trailingIconType="pencil" error={nameError} success={success("fullName", nameError)} fieldBackgroundColor="#F5F5F5" fieldBorderColor="#ADADAD" />
      <ProfileControlledField control={control} name="email" id="profile-email" label="Email" type="email" placeholder="Email@gmail.com" autoComplete="email" readOnly disabled trailingIconType="check" error={emailError} success={emailSuccess} fieldBackgroundColor="#F5F5F5" fieldBorderColor="#ADADAD" />
      <div className="flex w-[360px] items-start gap-[8px]">
        <ProfileControlledField control={control} name="mobileNumber" id="profile-mobile-number" label="Mobile Number" placeholder="555 123 456" autoComplete="tel" trailingIconType="check" error={mobileError} success={success("mobileNumber", mobileError)} wrapperClassName="min-h-[73px] w-[267px]" labelClassName="w-[267px]" inputBoxClassName="relative" labelInputGapClassName="mt-[8px]" trailingIconContainerClassName="absolute right-[14px] top-[12px] flex h-[22px] w-[22px] items-center justify-center" />
        <ProfileControlledField control={control} name="age" id="profile-age" label="Age" type="number" placeholder="29" autoComplete="off" trailingIconType="arrow" error={ageError} success={success("age", ageError)} wrapperClassName="min-h-[73px] w-[85px]" labelClassName="w-[85px]" inputBoxClassName="relative" labelInputGapClassName="mt-[8px]" trailingIconContainerClassName="absolute right-[14px] top-[12px] flex h-[22px] w-[22px] items-center justify-center" />
      </div>
